...
public :
	...
	struct SGMOption {
		...
		SGMOption(): num_paths(8), min_disparity(0), max_disparity(640),is_check_unique(true), uniqueness_ratio(0.95f),
			 is_check_lr(true), lrcheck_thres(1.0f),is_remove_speckles(true), min_speckle_aera(20),p1(10), p2_init(150) {
		}
	};
